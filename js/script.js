...
//index.html
sr.reveal ('.section__container',{delay:50});
sr.reveal ('.faq__card',{delay:50});

sr.reveal ('.package',{delay:50});
sr.reveal ('.search-box',{delay:50});
sr.reveal ('.dropdown',{delay:50});
sr.reveal ('.title',{delay:50});
sr.reveal ('.sub',{delay:50});

sr.reveal ('.footer',{delay:50});
sr.reveal ('.detail',{delay:50});
sr.reveal ('.about-us',{delay:50});
sr.reveal ('.copyright',{delay:50});

sr.reveal ('.newsletter',{delay:50});
sr.reveal ('.news-text',{delay:50});
sr.reveal ('.send',{delay:50});

sr.reveal ('.contact-message',{delay:50});
sr.reveal ('.container-message-map',{delay:50});
sr.reveal ('.container-message',{delay:50});

sr.reveal ('.about-content',{delay:50});
sr.reveal ('.box-about',{delay:50});
sr.reveal ('.box-about-text',{delay:50});

sr.reveal ('.Lets',{delay:50});
